...
function Section() {
  return (
    ...
    <div className='mt-[100px]'>
        <h1 className='font-bold text-[45px] text-center'>Biz haqimizda</h1>
        <h1 className='text-gray-700 text-[25px] text-center'>Sizning ishonchli sayohat hamkoringiz</h1>
        <div className='flex mx-auto justify-evenly mt-[60px] mb-[100px]'>
            <div className='w-[650px] p-[30px] rounded-2 shadow-xl shadow-gray-300 rounded-[20px]' >
